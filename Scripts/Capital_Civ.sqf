...
thisCapitalCivTrigger = _this select 0;
...
_allBuildings = nearestObjects [(getPos thisCapitalCivTrigger), ["HOUSE"], 300];   
...
//////Generator////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
_Houses= nearestObjects [(getPos thisCapitalCivTrigger) , ["HOUSE"], 400] ;  
_OtherHouses = nearestObjects [(getPos thisCapitalCivTrigger) , ["HOUSE"], 100] ; 
...
_mrkr setMarkerAlpha 0.001;  
 ...
 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 if (_Chance > 0) then {
 _nearRoad = selectRandom ((getpos thisCapitalCivTrigger) nearRoads 500 ) ; 
...
_V setDir _dir;
 ...
 _nearRoad = selectRandom ((getpos thisCapitalCivTrigger) nearRoads 3000 ) ; 
_pos = _nearRoad getRelPos [6, 0];
_V = createVehicle [selectRandom CivVehArray, [_pos select 0, _pos select 1, (_pos select 2) + 10], [], 0, "CAN_COLLIDE"]; 
_nextRoad = ( roadsConnectedTo _nearRoad ) select 0;
_dir = _nearRoad getDir _nextRoad;
...
_V setDir _dir;
 ...
 _nearRoad = selectRandom ((getpos thisCapitalCivTrigger) nearRoads 2000 ) ; 
_pos = _nearRoad getRelPos [6, 0];
_V = createVehicle [selectRandom CivVehArray, [_pos select 0, _pos select 1, (_pos select 2) + 10], [], 0, "CAN_COLLIDE"]; 
_nextRoad = ( roadsConnectedTo _nearRoad ) select 0;
_dir = _nearRoad getDir _nextRoad;
...
_I1_WP_1 SetWaypointType "CYCLE";
 ...
 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
_all = nearestObjects [(getPos thisCapitalCivTrigger), ["HOUSE"], 30];  
...
[G,thisCapitalCivTrigger getPos [(0 + (random 200)), (0 + (random 350))], (100 + (random 500))] call BIS_fnc_taskPatrol;
G = [selectRandom _allPositions, civilian,[selectRandom CivMenArray]] call BIS_fnc_spawnGroup;      
((units G) select 0) disableAI "all";
((units G) select 0) enableAI "MOVE";
((units G) select 0) enableAI "ANIM";
...
G = [selectRandom _allPositions, independent,[selectRandom GuerMenArray, selectRandom GuerMenArray]] call BIS_fnc_spawnGroup;     
[G,thisCapitalCivTrigger getPos [(0 + (random 100)), (0 + (random 350))], 90] call BIS_fnc_taskPatrol;
...
if (_REPSCORE < 7) then {
_nearRoad = selectRandom ((getpos thisCapitalCivTrigger) nearRoads 100 ) ; 
