...
_GSHPs = nearestobjects [player,[F_UAV_03],40000] select {alive _x == true};
	if (count _GSHPs > 0 ) then {
		
_UAV = nearestobjects [player,[F_UAV_03],40000] select 0;
...
_UAV = createVehicle [F_UAV_03,(getMarkerpos _CASStrt), [], 0, "FLY"];
