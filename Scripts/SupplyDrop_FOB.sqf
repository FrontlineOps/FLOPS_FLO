...
_Cargo = createVehicle ["B_Slingload_01_Cargo_F", _pos, [], 0, "FLY"]; 
_Cargo addAction ["<img size=2 color='#7CC2FF' image='Screens\FOBA\b_hq.paa'/><t font='PuristaBold' color='#7CC2FF'>UnPack FOB", "Scripts\FOBUNPACK.sqf"]; 
