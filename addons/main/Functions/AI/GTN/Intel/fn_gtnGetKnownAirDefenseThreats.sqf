...
private _reports = _worldState get "_airDefenseContacts";
{
    ...
    private _range = [_state get "mobileEngagementRange", _state get "staticEngagementRange"] select ((_y get "groupType") == "static_aa");
...

{
    ...
    private _range = [_state get "mobileEngagementRange", _state get "staticEngagementRange"] select (_type == "static_aa");
