...
if (_elapsed >= (_perf get "logThresholdMs")) then {
    ...
    ["GTN", 4, format ["[PERF] %1 cycle=%2 ms=%3 phases=%4 agenda=%5 active=%6 execution=%7", _commander get "_sideKey", _stats get "cyclesRun", _elapsed, _phaseMs, _agenda, count (_commander get "_intents"), _execution]] call FLO_fnc_log;
};
true
